...
async def chat(req: ChatRequest, request: Request):
    ...
    if intent == "general":
        ...
        general_system_prompt = (
            ...
            "## Critical Rule: Honesty Over Fabrication\n"
            "**IMPORTANT**: If you don't know something, say \"I don't know\" or \"I'm not familiar with that.\" "
            "NEVER make up information, book titles, authors, dates, or other facts. "
            "It is far better to admit uncertainty than to provide confidently incorrect information. "
    ...
    system_prompt = (
        ...
        "## Key Principles\n"
        "- **Honesty over fabrication** — If you don't know something, say \"I don't know\" or \"I'm not sure.\" "
        "NEVER make up information, especially book titles, authors, facts, or technical details. "
        "It's better to admit uncertainty than to provide confidently incorrect information.\n"
